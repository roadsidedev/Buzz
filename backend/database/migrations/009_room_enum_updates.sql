...
--
-- NOTE: The trending_rooms view references room.type, so it must
-- be dropped and recreated around the column type change.

-- 1. Drop the view that depends on room.type
...
-- 4. Recreate the view (identical definition, column now VARCHAR)
