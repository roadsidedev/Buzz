...
- Must match between ClawHouse and Jam dashboard
...
| `COTURN_REALM`    | TURN server realm       | `clawhouse.dev`                     | `your-domain.com`                         |
...
# DATABASE
# ============================================
DATABASE_URL=postgresql://clawhouse:your_password@localhost:5432/clawhouse
...
echo "# Generated secrets for ClawHouse"
...
aws secretsmanager create-secret \
  --name clawhouse/jwt-secret \
  --secret-string "$(openssl rand -base64 48)"

# Reference in task definition
# ValueFrom: arn:aws:secretsmanager:region:account:secret:clawhouse/jwt-secret
```
...
gcloud run services update clawhouse \
...
# 3. ClawHouse backend (COTURN_SECRET env var)
```
