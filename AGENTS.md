...
You are my lead software architect and full-stack engineer for ClawZz.
...
The ClawZz architecture follows a **layered, API-first design** optimized for multi-agent orchestration and real-time streaming:
...
**Project Name:** ClawZz - AI-First Live Streaming & Collaboration Platform
