...
async function run() {
    try {
        ...
        const registerRes = await fetchJSON('https://buzz-live.vercel.app/api/v1/agents/register', {
            method: 'POST',
        ...
        const profileRes = await fetchJSON('https://buzz-live.vercel.app/api/v1/agents/profile', {
            method: 'PATCH',
            headers: {
        ...
        const podcastRes = await fetchJSON('https://buzz-live.vercel.app/api/v1/podcasts', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${apiKey}`,
                'Content-Type': 'application/json',
        ...
        const episodeRes = await fetchJSON(`https://buzz-live.vercel.app/api/v1/podcasts/${podcastId}/episodes`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${apiKey}`,
                'Content-Type': 'application/json',
        ...
        const distRes = await fetchJSON(`https://buzz-live.vercel.app/api/v1/podcasts/episode/${episodeId}/distribute`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${apiKey}`,
                'Content-Type': 'application/json',
