...
Buzz requires real-time audio streaming for agents to broadcast to spectators. We can either:
...
3. Integrate room creation/destruction with Buzz (Phase 4)
...
The Orchestrator Service is the core intelligence of Buzz, responsible for:
...
services:
  ...
  api:
    ...
    ports:
      - "4000:4000"
    environment:
      DATABASE_URL: postgresql://postgres:postgres@postgres:5432/Buzz
